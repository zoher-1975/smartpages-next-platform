...
export function PlatformHeader({ transparent }: PlatformHeaderProps) {
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 ${
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className={`font-bold text-base ${transparent ? 'text-white' : 'text-gray-900'}`}>
            Smart Pages
          </span>
        </Link>
        ...
        <Link
          href="/store/demo"
          className="flex items-center gap-1.5 bg-[#25D366] text-white
